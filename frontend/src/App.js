...
import CompanyProfileView from './pages/candidate/CompanyProfileView';
...
import WorkflowSettings from './pages/company/WorkflowSettings';
...
function AppRoutes() {
 ...
 <Route path="/candidate/company/:id" element={<ProtectedRoute roles={['CANDIDATE']}><Layout><CompanyProfileView /></Layout></ProtectedRoute>} />
 ...
 <Route path="/company/workflows" element={<ProtectedRoute roles={['COMPANY']}><Layout><WorkflowSettings /></Layout></ProtectedRoute>} />
 ...
 <Route path="/admin/support" element={<ProtectedRoute roles={['ADMIN']}><Layout><SupportDashboard /></Layout></ProtectedRoute>} />
 <Route path="/admin/profile" element={<ProtectedRoute roles={['ADMIN']}><Layout><AdminProfile /></Layout></ProtectedRoute>} />
...
export default function App() {
 return (
 <GoogleOAuthProvider clientId={process.env.REACT_APP_GOOGLE_CLIENT_ID || '824561939701-p1ueo7u43jm7q3fkotonga92cfgk103i.apps.googleusercontent.com'}>
 <BrowserRouter>
 <ThemeProvider>
 <AuthProvider>

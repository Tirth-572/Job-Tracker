...
export const companyAPI = {
 ...
 removeLogo: () => api.delete('/companies/me/logo'),
...
export const jobsAPI = {
 ...
 repostJob: (id) => api.post(`/jobs/${id}/repost`),
...
export const supportAPI = {
 ...
 createTicket: (data) => api.post('/support/my-tickets', data),
 getTicket: (id) => api.get(`/support/${id}`),
 sendMessage: (id, formData) => api.post(`/support/${id}/messages`, formData),
...
export const workflowAPI = {
 ...
 createStage: (data) => api.post('/workflows', data),

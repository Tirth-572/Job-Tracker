...
import { Globe, MapPin, Users, Upload, Edit2 } from 'lucide-react';
...
export default function CompanyProfile() {
  ...
  if (!company) return <div className="animate-pulse space-y-4">{[...Array(3)].map((_, i) => <div key={i} className="h-28 bg-gray-200 dark:bg-gray-800 rounded-xl" />)}</div>;
      ...
      <Card className="p-6">
        <div className="flex items-start gap-5">
          <div className="relative group">
            ...
            <div {...getRootProps()} className="absolute inset-0 bg-black/50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer flex items-center justify-center">
              <input {...getInputProps()} />

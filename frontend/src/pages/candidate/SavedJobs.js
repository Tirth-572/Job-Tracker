...
import { JOB_TYPE_CONFIG, formatRelativeDate } from '../../lib/utils';
            ...
            return (
              <Card key={jobId} className="p-4 flex items-center gap-4">
                ...
                <div className="flex gap-2 shrink-0">
                  <Link to="/candidate/jobs"><Button size="sm">Apply</Button></Link>
                  <Button variant="secondary" size="sm" onClick={() => unsave(jobId)}>Remove</Button>
                </div>
              </Card>
            );
          })}

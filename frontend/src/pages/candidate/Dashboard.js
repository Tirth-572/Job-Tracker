...
import { FileText, BookmarkCheck, CheckCircle, Clock, Briefcase, ArrowRight, TrendingUp, Building2 } from 'lucide-react';
...
export default function CandidateDashboard() {
 ...
 ? <img src={getFileUrl(app.job.company.logo)} alt="" className="w-full h-full object-contain rounded-lg" />
 ...
 {job.company?.logo
 ? <img src={getFileUrl(job.company.logo)} alt="" className="w-full h-full object-contain rounded-lg" />
